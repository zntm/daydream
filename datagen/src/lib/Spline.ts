 ...
 * 
 * Example usage for cave depth smoothing:
 * ```typescript
 * new Spline([
 *     new SplinePoint(0, 0),                                    // At surface: no caves
 *     new SplinePoint(16, 0.2, SplineEasing.EaseOut),           // Slow ramp up
...
export class Spline {
     ...
     */
    addPoint(position: number, value: number, easing?: SplineEasing): Spline {
