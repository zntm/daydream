...
import { Region, RegionBiome, RegionCaveBiome, RegionTerrain } from "../lib/Region";
    ...
    new DatagenReturnData(
        ...
        [
            ...
            new Region("emeraldine", {
                category: "temperate",
                biomes: [
                    new RegionBiome("phantasia:surface/emeraldine/greenia", 3, "flat"),
                    new RegionBiome("phantasia:surface/emeraldine/birchwoods", 2, "flat"),
                    new RegionBiome("phantasia:surface/emeraldine/sakurai", 1, "flat"),
                    new RegionBiome("phantasia:surface/emeraldine/sunflora", 2, "flat"),
                    new RegionBiome("phantasia:surface/emeraldine/honeygrove", 1, "flat"),
                ],
            ...
            new Region("rotfens", {
                category: "humid",
                biomes: [
                    new RegionBiome("phantasia:surface/rotfens/mangroots", 2, "any"),
                    new RegionBiome("phantasia:surface/rotfens/boggins", 3, "flat"),
                ],
                caveBiomeDefault: "phantasia:cave/chasm",
                caveBiomes: [
                    new RegionCaveBiome("phantasia:cave/depths", { minDepth: 200, noiseThreshold: 0.6 })
                ],
                terrain: new RegionTerrain({
                    heightOffset: -12,
                    amplitudeMin: 15,
            ...
            new Region("dustbunny", {
                ...
                biomes: [
                    ...
                    new RegionBiome("phantasia:surface/dustbunny/redwaste", 2, "flat"),
                    new RegionBiome("phantasia:surface/dustbunny/badlands", 2, "hilly"),
                    new RegionBiome("phantasia:surface/dustbunny/oasin", 1, "flat"),
                    new RegionBiome("phantasia:surface/dustbunny/goldgrass", 2, "any"),
                ],
                caveBiomeDefault: "phantasia:cave/chasm",
                caveBiomes: [
            ...
            new Region("borea", {
                ...
                biomes: [
                    ...
                    new RegionBiome("phantasia:surface/borea/silversteep", 2, "hilly"),
                    new RegionBiome("phantasia:surface/borea/needlefall", 2, "flat"),
                    new RegionBiome("phantasia:surface/borea/aurospring", 1, "flat"),
                ],
                caveBiomeDefault: "phantasia:cave/chasm",
                caveBiomes: [
            ...
            new Region("glacien", {
                ...
                biomes: [
                    ...
                    new RegionBiome("phantasia:surface/glacien/flakerocks", 2, "hilly"),
                    new RegionBiome("phantasia:surface/glacien/frostenisle", 2, "flat"),
                ],
                caveBiomeDefault: "phantasia:cave/chasm",
                caveBiomes: [
                    new RegionCaveBiome("phantasia:cave/depths", { minDepth: 80, noiseThreshold: 0.4 })
                ],
                terrain: new RegionTerrain({
                    heightOffset: -4,
                    amplitudeMin: 20,
