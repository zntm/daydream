import { Effect, EffectType } from "./effects/lib/Effect";
import { EffectModifier } from "./effects/lib/EffectModifier";
import { EffectParticle } from "./effects/lib/EffectParticle";
...
export default Object.entries(effects).map(
    ([id, data]): DatagenReturnData => ({
        destination: `generated/data/effects/${id}.json`,
        data,
    })
);