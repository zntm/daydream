...
on_draw = function()
{
    ...
    draw_text_transformed_colour(x + (sprite_get_width(spr_Menu_Title) * 2 / 2), y + (sprite_get_height(spr_Menu_Title) * 2), splash_text, 1, 1, 12, c_white, c_white, c_white, c_white, 1);
