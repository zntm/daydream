on_select_hold = function(_x, _y, _id)
{
	...
	global.worlds_list_offset = lerp(0, global.worlds_list_size, normalize(y, 86, 454));
	
	var _offset = global.worlds_list_offset;
...
on_step = function()
{
	...
	global.worlds_list_offset = lerp(0, global.worlds_list_size, _);
