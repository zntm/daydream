...
const aetheris = new Biome("phantasia:sky/aetheris")
    ...
    .setTile(new BiomeTile(
        new BiomeTileLayer([new BiomeTileEntry("phantasia:grass_block")], [DIRT_WALL, EMPTY_WALL]),
        new BiomeTileLayer([new BiomeTileEntry("phantasia:dirt")], [DIRT_WALL, EMPTY_WALL]),
