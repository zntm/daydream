...
export class AchievementCondition {
    ...
    setEvent(event: AchievementTrigger): this {
        this.event = event;
        return this;
    }

    setStatistic(stat_id: string, count: number): this {
        this.statistic = stat_id;
        this.count = count;
        return this;
    }

    setItemId(id: string | string[]): this {
...
export class Achievement {
    ...
    setReward(itemId: string, amount: number = 1): this {
