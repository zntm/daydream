...
export class Noise {
    ...
    setYOffset(y_offset: number): this {
        this.y_offset = y_offset;
        return this;
    }
    ...
    setNoiseScale(x: number, y: number): this {
        this.noise_scale_x = x;
        this.noise_scale_y = y;
        return this;
    }

    setOctaveOffset(offset: number): this {
        this.octaves_offset = offset;
        return this;
    }

    setSplineX(spline: Spline): this {
        this.spline_x = spline;
        return this;
    }

    setSplineY(spline: Spline): this {
