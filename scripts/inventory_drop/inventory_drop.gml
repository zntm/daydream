...
function inventory_drop()
{
	...
	{
        spawn_item_drop(x, y - TILE_SIZE, _holding, sign(image_xscale), image_xscale * INVENTORY_DROP_XVELOCITY, -INVENTORY_DROP_YVELOCITY, GAME_TICK * 3);
    ...
    spawn_item_drop(x, y - TILE_SIZE, variable_clone(_holding).set_amount(1), sign(image_xscale), image_xscale * INVENTORY_DROP_XVELOCITY, -INVENTORY_DROP_YVELOCITY, GAME_TICK * 3);
