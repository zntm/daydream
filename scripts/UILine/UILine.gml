/* ui line element - draws a line from point a to point b */
...
function UILine(_x, _y) : UIElement(_x, _y, 0, 0) constructor 
{
    ...
    /* recalculate width/height from start/end points */
