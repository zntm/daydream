...
#macro INVENTORY_GUI_SURFACE_PADDING (INVENTORY_SLOT_SCALE * 8)
...
global.gui_inventory = {
    hotbar: {
        ...
        surface_xoffset: 0,
        surface_yoffset: 0,
        surface_width:  (INVENTORY_GUI_SURFACE_PADDING * 2) + INVENTORY_BACKPACK_XOFFSET + (INVENTORY_SLOT_DIMENSION_SCALED * INVENTORY_LENGTH.ROW),
        surface_height: (INVENTORY_GUI_SURFACE_PADDING * 2) + INVENTORY_BACKPACK_YOFFSET + INVENTORY_SLOT_DIMENSION_SCALED,
        outline: [
            {
                colour: INVENTORY_OUTLINE_COLOUR,
                xoffset: INVENTORY_GUI_SURFACE_PADDING - INVENTORY_OUTLINE_THICKNESS - (INVENTORY_SLOT_DIMENSION / 2),
                yoffset: INVENTORY_GUI_SURFACE_PADDING - INVENTORY_OUTLINE_THICKNESS - (INVENTORY_SLOT_DIMENSION / 2),
    ...
    base: {
        ...
        surface_yoffset: 0,
        surface_width:  (INVENTORY_GUI_SURFACE_PADDING * 2) + INVENTORY_BACKPACK_XOFFSET + (INVENTORY_SLOT_DIMENSION_SCALED * INVENTORY_LENGTH.ROW),
        surface_height: (INVENTORY_GUI_SURFACE_PADDING * 2) + INVENTORY_BACKPACK_YOFFSET + (INVENTORY_SLOT_DIMENSION_SCALED * (INVENTORY_LENGTH.BASE div INVENTORY_LENGTH.ROW)),
        outline: [
            {
                colour: INVENTORY_OUTLINE_COLOUR,
                xoffset: INVENTORY_GUI_SURFACE_PADDING - INVENTORY_OUTLINE_THICKNESS - (INVENTORY_SLOT_DIMENSION / 2),
            ...
            {
                colour: INVENTORY_OUTLINE_COLOUR,
                xoffset: INVENTORY_GUI_SURFACE_PADDING + INVENTORY_BACKPACK_XOFFSET - 1 - (INVENTORY_SLOT_DIMENSION / 2),
                yoffset: INVENTORY_GUI_SURFACE_PADDING + INVENTORY_BACKPACK_YOFFSET - 1,
                width:  (INVENTORY_OUTLINE_THICKNESS * 2) + (INVENTORY_SLOT_DIMENSION * INVENTORY_LENGTH.ROW),
    ...
    armor_helmet: {
        ...
        surface_width:  (INVENTORY_GUI_SURFACE_PADDING * 2) + INVENTORY_SLOT_DIMENSION_SCALED,
        surface_height: (INVENTORY_GUI_SURFACE_PADDING * 2) + INVENTORY_SLOT_DIMENSION_SCALED,
        outline: [
            {
                colour: INVENTORY_OUTLINE_COLOUR,
                xoffset: INVENTORY_GUI_SURFACE_PADDING - INVENTORY_OUTLINE_THICKNESS - (INVENTORY_SLOT_DIMENSION / 2),
    ...
    accessory: {
        ...
        surface_width:  (INVENTORY_GUI_SURFACE_PADDING * 2) + INVENTORY_SLOT_DIMENSION_SCALED,
        surface_height: (INVENTORY_GUI_SURFACE_PADDING * 2) + (INVENTORY_SLOT_DIMENSION_SCALED * INVENTORY_LENGTH.ACCESSORY),
        outline: [
            {
                colour: INVENTORY_OUTLINE_COLOUR,
                xoffset: INVENTORY_GUI_SURFACE_PADDING - INVENTORY_OUTLINE_THICKNESS - (INVENTORY_SLOT_DIMENSION / 2),
