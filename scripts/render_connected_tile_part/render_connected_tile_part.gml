function render_connected_tile_part(_buffer, _uv, _surface_width, _surface_height, _cos, _sin, _position, _sprite, _index, _left, _top, _width, _height, _x, _y, _xscale, _yscale, _rotation, _colour, _alpha)
{
    ...
    vertex_float4(_buffer, _index, _sprite.number, _sprite.width, _sprite.height);
