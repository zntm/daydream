function worldgen_get_tile_wall(_x, _y, _surface_biome, _cave_biome, _surface_height, _seed, _is_cave_above = false, _world_data = global.world_data[$ global.world_save_data.dimension], _biome_data = global.biome_data)
{
