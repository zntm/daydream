...
function worldgen_get_heat(_x, _y, _seed)
{
    ...
    {
        _buffer = new Noise(_x2 * WORLDGEN_HEAT_NOISE_SIZE, _y2 * WORLDGEN_HEAT_NOISE_SIZE, WORLDGEN_HEAT_NOISE_SIZE, 1, WORLDGEN_SIZE_HEAT, _world_data.get_surface_biome_heat_octave(), _world_data.get_surface_biome_heat_roughness(), _seed);
