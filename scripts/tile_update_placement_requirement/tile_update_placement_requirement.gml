function tile_update_placement_requirement(_x, _y, _z, _item)
{
    ...
    for (var i = 0; i < _length; ++i)
    {
        ...
        show_debug_message($"t: {_item.get_id()} {_x} {_y} {_z}\n{_x + _requirement.xoffset} {_y + _requirement.yoffset} {((_z2 == "z") ? _z : __z[$ _z2])}\n{_requirement} {_tile}")
        
        if (_tile == TILE_EMPTY) continue;
        
        var _requirement_id = _requirement[$ "id"];
        
        show_debug_message($"t: {_requirement_id} {_tile.get_id()}")
