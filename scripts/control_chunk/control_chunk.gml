function control_chunk(_player_x, _player_y, _camera_x, _camera_y, _camera_width, _camera_height)
{
    ...
    for (var i = chunk_in_view_length - 1; i >= 0; --i)
    {
        ...
        if (_chunk == undefined) || (_chunk.boolean & (CHUNK_BOOL.GENERATED | CHUNK_BOOL.QUEUED)) continue;
        
        /* calculates priority based on distance to player (lower = higher priority) */
