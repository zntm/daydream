...
function sfx_diegetic_play(_x1, _y1, _x2, _y2, _id, _pitch_offset = 0.2, _gain = global.settings.audio_sfx, _world_height = global.world_data[$ global.world.dimension].get_world_height())
{
