...
{
    var _durability_max = _data.get_durability();
    ...
    draw_sprite_ext(spr_Square, 0, _x, _y, _xscale, _yscale, 0, _data.get_durability_base_colour(), 1);
    ...
    var _durability_colour_length = _data.get_durability_colour_length();
    
    for (var l = 0; l < _durability_colour_length; ++l)
    {
        var _durability_data = _data.get_durability_colour(l);
    ...
    draw_sprite_ext(spr_Square, 0, _x, _y, _xscale * _percentage, _yscale, 0, merge_colour(_durability_colour_first, _durability_colour_next, _merge_amount), 1);
}