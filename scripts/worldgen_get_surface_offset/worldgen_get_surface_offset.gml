function worldgen_get_surface_noise_offset(_x, _seed)
{
    ...
    return _world_data.get_surface_noise_offset_min()
        + abs(round(open_simplex_noise(
            _x * _world_data.get_surface_noise_offset_scale(),
            _world_data.get_surface_noise_offset_y(),
            _amplitude,
            _octaves
        )));
}