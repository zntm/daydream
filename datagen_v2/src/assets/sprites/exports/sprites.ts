import { DatagenReturnData, Sprite } from "../../../lib";
...
const sourceImageDir = __dirname;
...
for (const file of allFiles) {
    ...
    const relDir = file.parentPath.slice(sourceImageDir.length).replace(/^[\\\/]/, "");
...
export default Promise.all([...individualPromises, ...groupPromises]);
